    ...
    <div className="my-3 overflow-hidden rounded-[20px] border border-[rgba(252,253,255,0.1)] bg-[#0e0f11]">
      <div className="flex items-center justify-between border-b border-[rgba(252,253,255,0.1)] px-4 py-2.5">
        <div className="flex items-center gap-2">
          <svg className="h-3.5 w-3.5 text-[#00dae8]" viewBox="0 0 24 24" fill="currentColor">
      ...
      <pre className="overflow-x-auto whitespace-pre-wrap px-5 py-4 font-sans text-[14px] leading-[1.7] text-[#fcfcfd]">
        {text || (streaming ? " " : "")}
      </pre>
    </div>
  );
...
function QuestionsCard({
  ...
  return (
    <div className="my-3 overflow-hidden rounded-[20px] border border-[rgba(252,253,255,0.1)] bg-[#0e0f11]">
      <div className="flex items-center justify-between border-b border-[rgba(252,253,255,0.1)] px-4 py-2.5">
        <div className="flex items-center gap-2">
          <svg className="h-3.5 w-3.5 text-[rgba(252,252,253,0.6)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M9 9a3 3 0 1 1 4.5 2.6c-.9.5-1.5 1.4-1.5 2.4M12 17h.01" />
          </svg>
          <span className="text-[12px] font-medium uppercase tracking-[1.2px] text-[rgba(252,252,253,0.6)]">
            Quick questions
          </span>
      ...
      <div className="space-y-5 px-5 py-5">
        {parsed.intro && (
          <p className="text-[13.5px] leading-relaxed text-[rgba(252,252,253,0.85)]">
            {parsed.intro}
          </p>
        )}
...
function IconWand() {
  return (
    <svg className="h-3 w-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M15 4V2M15 10V8M11 6h2M17 6h2M3 21l9-9M14 7l3 3" />
    </svg>
  );
}
